...
class LevelConfig:
    ...
    default_lr: float
    grad_memory: object | None = None  # LevelGradientMemory for HGC
...
class LevelOptimizerManager:
    def __init__(self, config: LevelConfig):
        ...
        self.grad_memory = config.grad_memory  # HGC gradient memory (may be None)
        for spec in config.specs:
            ...
            optimizer = build_optimizer(
                ...
                grad_memory=config.grad_memory,
